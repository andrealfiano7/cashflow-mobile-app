...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-slate-900/95 backdrop-blur-xl border-t border-slate-800 pb-safe">
      <div className="max-w-md mx-auto px-2 h-16 flex items-center justify-around relative">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center flex-1 py-1 transition-all ${
            activeTab === 'transactions' ? 'text-brand-400 font-semibold' : 'text-slate-400 hover:text-slate-200'
          }`}
        >
        ...
        <div className="flex-1 flex justify-center -mt-6">
          <button
            ...
            className="w-13 h-13 rounded-full bg-gradient-to-tr from-brand-600 via-emerald-500 to-teal-400 text-white shadow-lg shadow-brand-500/30 flex items-center justify-center hover:scale-105 active:scale-95 transition-all border-4 border-slate-900 focus:outline-none"
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center flex-1 py-1 relative transition-all ${
            activeTab === 'proofs' ? 'text-brand-400 font-semibold' : 'text-slate-400 hover:text-slate-200'
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center flex-1 py-1 transition-all ${
            activeTab === 'reports' ? 'text-brand-400 font-semibold' : 'text-slate-400 hover:text-slate-200'
          }`}
        >
