...
-- 6. Sample Transaksi Awal (Seed Data Realistis Rupiah)
INSERT INTO public.transactions (date, type, category_name, amount, description, proof_url, proof_file_name, proof_file_size, proof_file_type, verification_status) VALUES
(CURRENT_DATE - INTERVAL '10 days', 'income', 'Gaji & Upah', 12500000.00, 'Gaji Bulanan Utama PT Teknologi', 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&w=600&q=80', 'slip_gaji_september.pdf', 245000, 'application/pdf', 'verified'),
(CURRENT_DATE - INTERVAL '8 days', 'expense', 'Tagihan & Utilitas', 1450000.00, 'Pembayaran Listrik PLN & Air PDAM', 'https://images.unsplash.com/photo-1607344645866-009c320c5ab8?auto=format&fit=crop&w=600&q=80', 'struk_pln_pdam.jpg', 182000, 'image/jpeg', 'verified'),
(CURRENT_DATE - INTERVAL '6 days', 'expense', 'Belanja', 2350000.00, 'Belanja Perlengkapan Kantor & Rumah', 'https://images.unsplash.com/photo-1556742049-0a67e557224f?auto=format&fit=crop&w=600&q=80', 'struk_supermarket.jpg', 312000, 'image/jpeg', 'verified'),
(CURRENT_DATE - INTERVAL '5 days', 'expense', 'Makanan & Minuman', 485000.00, 'Makan Siang Tim & Kopi', 'https://images.unsplash.com/photo-1559925393-8be0ec4767c8?auto=format&fit=crop&w=600&q=80', 'bukti_qris_resto.png', 98000, 'image/png', 'verified'),
(CURRENT_DATE - INTERVAL '3 days', 'income', 'Hasil Penjualan / Bisnis', 4750000.00, 'Pembayaran Invoice Client Web Project', 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?auto=format&fit=crop&w=600&q=80', 'transfer_bca_client.jpg', 420000, 'image/jpeg', 'verified'),
(CURRENT_DATE - INTERVAL '2 days', 'expense', 'Kebutuhan Rumah', 850000.00, 'Isi Ulang Gas & Galon Bulanan', 'https://images.unsplash.com/photo-1584438784894-089d6a62b8fa?auto=format&fit=crop&w=600&q=80', 'nota_toko_berkah.jpg', 154000, 'image/jpeg', 'verified'),
(CURRENT_DATE - INTERVAL '1 days', 'expense', 'Transfer Keluar', 1200000.00, 'Transfer Cicilan Kendaraan', 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?auto=format&fit=crop&w=600&q=80', 'mutasi_mbanking_transfer.jpg', 215000, 'image/jpeg', 'pending'),
(CURRENT_DATE, 'income', 'Dividen & Investasi', 850000.00, 'Hasil Dividen Reksadana Pasar Uang', 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=600&q=80', 'screenshot_bibit.png', 320000, 'image/png', 'pending');
